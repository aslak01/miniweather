...
>
  ...
  <symbol id="s48">
    ...
    <use
      ...
      width="100"
      height="100"
      transform="translate(15,79) scale(1,1)"
    />
    <use
      xlink:href="#raindrop"
      x="0"
      ...
      width="100"
      height="100"
      transform="translate(32,86) scale(1,1)"
    />
    <use
      xlink:href="#raindrop"
      x="0"
      ...
      width="100"
      height="100"
      transform="translate(47,80) scale(1,1)"
    />
    <use
      xlink:href="#snowflake"
      x="0"
      ...
      width="100"
      height="100"
      transform="translate(58,88) scale(1,1)"
    />
    <use
      xlink:href="#raindrop"
      x="0"
      ...
      width="100"
      height="100"
      transform="translate(74,80) scale(1,1)"
    />
  </symbol>
  <symbol id="sunWinter">
  ...
  <symbol id="s43m">
    <g mask="url(#cloud_3_18_1_1_5)">
      <use
        ...
        width="100"
        height="100"
        transform="translate(0,19) scale(0.7,0.7)"
      />
    </g>
